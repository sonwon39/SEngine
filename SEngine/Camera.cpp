...
void Camera::Initialize()
{
    ...
    m_globalConstant.view = DirectX::XMMatrixLookToLH(m_eyePosition, m_forwardDir, m_upDir);

    m_fovRadians = DirectX::XMConvertToRadians(m_fovDegrees);
    m_aspectRatio = (float)m_width / m_height;

    perspectiveMat = DirectX::XMMatrixPerspectiveFovLH(m_fovRadians, m_aspectRatio, m_nearZ, m_farZ);
